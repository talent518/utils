...
int main(int argc, char *argv[]){
	...
	const char *sqls[] = {
		...
		"CREATE TABLE directories(dirId INT(11) UNSIGNED NOT NULL AUTO_INCREMENT, parentId INT(11) NOT NULL, dirName VARCHAR(255) NOT NULL, pathName VARCHAR(4096) NOT NULL, linkTarget VARCHAR(4096), nlinks INT(11) UNSIGNED, dirMode MEDIUMINT UNSIGNED, dirType ENUM('REG','DIR','CHR','BLK','FIFO','LNK','SOCK') NOT NULL, uid INT(11) UNSIGNED NOT NULL, gid INT(11) UNSIGNED NOT NULL, size BIGINT UNSIGNED NOT NULL, accessTime DATETIME NOT NULL, modifyTime DATETIME NOT NULL, changeTime DATETIME NOT NULL, PRIMARY KEY(dirId), UNIQUE INDEX i_directories_parentId_dirName (parentId, dirName)) ENGINE=InnoDB DEFAULT CHARSET=utf8",
